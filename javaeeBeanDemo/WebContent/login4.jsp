...
<%-- 	
	记录在application中的量会一直保持，直到服务器关闭或重启
	刷新，再开页面，再开浏览器等客户端操作，都会累计加1
--%>
<jsp:useBean id="myBean" class="bean.MyBean" scope="application"></jsp:useBean>
<%
...
<DIV id=PageBody>
<DIV class=Sidebar>
<FORM name="form1" action="login4.jsp" method="post">
<UL>
				<%
