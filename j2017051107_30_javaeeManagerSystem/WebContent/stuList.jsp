...
%>
	...
	<tr>
		...
		<td>
			<a href="stucontroller/stuUpdate.jsp?stuNo=<%=rs.getString("stuNo")%>"><img src="/j2017051107_30_javaeeManagerSystem/imgs/edit.gif"/>
			</a>
			<a href="<%=request.getContextPath()%>/StuServlet?action=del&stuNo=<%=rs.getString("stuNo")%>">
				<img src="/j2017051107_30_javaeeManagerSystem/imgs/del.gif"/>
			</a>
		</td>
	</tr>
	<%
	...
	%></table>
	<a href="/j2017051107_30_javaeeManagerSystem/stucontroller/stuAdd.jsp">添加学生</a>
</body>
</html>