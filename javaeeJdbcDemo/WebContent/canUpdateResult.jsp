	...
	<div id="container">
		...
		<div id="body" class="clear">
			...
			<div id="body_left">
				<!-- ============= 好书推荐（开始） ============= -->
				<h2>
					<img src="imgs/bullet1.gif" />更新前结果集
				</h2>
...
/* 								rs.absolute(5);
								rs.updateInt("id", 32);
								rs.updateString("name", "老人与狗");
								rs.updateRow(); */
								//插入一条数据记录
								rs.moveToInsertRow();
								rs.updateInt(1, 36);
								rs.updateString(2, "猫和老鼠3");
								rs.updateString(3, "汤姆4");
								rs.updateInt(4, 20);
								rs.updateString(5, "教育出版社42");
								rs.updateString(6, "无42");
								rs.insertRow();
								//删除一行数据
								//rs.absolute(4);
								//rs.deleteRow();
					...
					<h2>
						<img src="imgs/bullet1.gif" />更新后结果集
					</h2>
					<table border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC"
						width="100%">
						<tr align="center" bgcolor="#FAFAF1">
