...
/* 		statement = conn.createStatement();
		...
		CallableStatement callableStatement = conn.prepareCall("{call p_searchBooksByPrice(?,?)}");
...
%>
	...
	<tr>
		...
		<td>
			<a href="bookUpdate.jsp?id=<%=rs.getString("id")%>">
				<img src="imgs/edit.gif"/>
			</a>
			<a href="bookServlet?action=del&id=<%=rs.getString("id")%>">
