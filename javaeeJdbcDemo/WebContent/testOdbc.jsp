...
<body>
				...
				<table width="195" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width="178" height="67" valign="middle"><img
							src="images/ny_list_001.jpg" alt="" width="188" height="66" />
						</td>
					</tr>
				</table>
			...
			<td width="1624" valign="top"><table width="582" border="0"
						...
						<td colspan="2" rowspan="2" valign="top" bgcolor="#C4F2E5"><table
								...
								<tr>
									<th height="25" colspan="2" align="left" bgcolor="#FFFFFF">
										...
										src="images/bt3.jpg" border="0" alt="" />
									</th>
								</tr>
							</table>
							<div id="wrap">
								<h2>测试ODBC到Access数据库的连接</h2>
								<hr>
									<%
										try {
											...
											out.println("JDBC-ODBC连接Access数据库成功！！");
										} catch (Exception ex) {
											ex.printStackTrace();
											out.println("JDBC-ODBC连接Access数据库失败！！");
										}
									%>
					...
					<tr>
						<td width="2" height="95" valign="top" bgcolor="#099690"><img
							src="/images/zw/ny_0122.jpg" width="2" height="1" />
						</td>
					</tr>
				</table>
	...
	<table width="778" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td align="center"><p>
					<a href="http://www.cuit.edu.cn">关于我们</a> | <a
						href="http://www.cuit.edu.cn">免责声明</a> | <a
						href="http://www.cuit.edu.cn">广告合作</a> | <a
						href="http://www.cuit.edu.cn">知识产权</a> | <a
						href="http://www.cuit.edu.cn">支付方式</a> | <a
						href="http://www.cuit.edu.cn">联系方式</a> | <a
						href="http://www.cuit.edu.cn">加入我们</a><br /> <em>Copyrights
