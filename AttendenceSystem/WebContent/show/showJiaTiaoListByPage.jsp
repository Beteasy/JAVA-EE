        ...
        <div class='box-content box-no-padding'>
            <div class='responsive-table'>
                <div class='scrollable-area'>
                    <table class='table' style='margin-bottom:0;'>
						...
						%>
							...
							%>
							<td>
                                <span class='label label-label-warning'><%=status%></span>
                            </td>
							<%
							}
							%>
							<%
								if(jiaTiao.getStatus()==1){
							%>
							 <td>
                            ...
                            <td>
                                <div class='text-right'>
                                    <a class='btn btn-success btn-mini' href='/AttendenceSystem/show/jiaTiaoDetail.jsp?id=<%=jiaTiao.getId()%>'>
                                        	查看
                                    </a>
                                </div>
                            </td>
				...
				for (int j = 1; j <= pageCount; j++) {
					out.print("&nbsp;&nbsp;<a href='?pageNum=" + j + "&action=search&range="+range+"'>"
										+ j + "</a>");
							}
		%>
                </div>
