 ...
 */
@WebServlet("/SearchAttenByClassId")
public class SearchAttenByClassId extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchAttenByClassId() {
        super();
...
//		response.setCharacterEncoding("UTF-8");
		...
		kaoQinList = TeacherService.searchAttenByStuNo(classId,dateString,courseNo);
